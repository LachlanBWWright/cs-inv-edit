...
describe("dashboard service", () => {
  ...
  it("rejects storage moves into a full storage unit", () => {
    ...
    const storage = {
      ...candidateStorage,
      occupied: candidateStorage.capacity,
    };
  ...
  it("rejects sticker plans for items still in storage", () => {
    const item = dashboardTestData.inventory.find(
      (candidate) => candidate.inStorage,
    );
