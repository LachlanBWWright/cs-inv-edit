...
const api = {
  ...
  tradeAccounts: () => invokeResult(backendSchemas.tradeAccounts, "backend:tradeAccounts"),
  refreshTradeAccounts: (steamId?: string) => invokeResult(backendSchemas.tradeAccounts, "backend:refreshTradeAccounts", steamId),
  createTradeOffer: (input: unknown) => invokeResult(backendSchemas.tradeMutation, "backend:createTradeOffer", input),
  acceptTradeOffer: (id: string) => invokeResult(backendSchemas.tradeMutation, "backend:acceptTradeOffer", id),
  counterTradeOffer: (id: string, input: unknown) => invokeResult(backendSchemas.tradeMutation, "backend:counterTradeOffer", id, input),
