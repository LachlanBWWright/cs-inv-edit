...
func TF2OperationMapping(operation string) (TF2OperationProtocol, bool) {
	mappings := map[string]TF2OperationProtocol{
		...
		"tf2.crafting.craft":              {EMsg: TF2EMsgCraft, Protobuf: false, FeatureFlag: "enableTf2Crafting", Verified: true},
		"tf2.crafting.trade-up":           {EMsg: TF2EMsgCraftCollectionUpgrade, Protobuf: true, FeatureFlag: "enableTf2Tradeups", Verified: true},
		"tf2.crafting.halloween-offering": {EMsg: TF2EMsgCraftHalloweenOffering, Protobuf: true, FeatureFlag: "enableTf2Tradeups", Verified: true},
		"tf2.crafting.stat-clock":         {EMsg: TF2EMsgCraftCommonStatClock, Protobuf: true, FeatureFlag: "enableTf2Tradeups", Verified: true},
