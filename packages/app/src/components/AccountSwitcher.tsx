  ...
  return (
    <div class="mt-3 flex flex-wrap gap-2">
      ...
      <Show
        ...
        fallback={
          <button
            class="rounded-md border border-cyan-500/40 bg-cyan-500/10 px-2.5 py-1.5 text-xs font-medium text-cyan-200 hover:bg-cyan-500/20"
      ...
      <button
        class="rounded-md border border-rose-500/30 bg-rose-500/10 px-2.5 py-1.5 text-xs font-medium text-rose-300 hover:bg-rose-500/20"
  ...
  return (
    <div class="w-full text-sm text-slate-200">
      <Show
        ...
        fallback={
          <p class="rounded-lg border border-slate-800 bg-slate-950/70 p-3 text-xs text-slate-400">
      ...
      <button
        class="mt-3 w-full rounded-lg border border-dashed border-cyan-500/40 px-3 py-2 text-xs font-medium text-cyan-200 transition hover:bg-cyan-500/10"
