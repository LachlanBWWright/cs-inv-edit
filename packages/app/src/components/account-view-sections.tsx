...
function QrSignInPanel(props: QrSignInPanelProps) {
  return (
    <section
      class="flex min-h-80 flex-col items-center justify-center border-t border-slate-800 pt-8 text-center md:border-0 md:pt-0"
    ...
    >
      ...
      <p class="mt-2 max-w-sm text-sm text-slate-400">
        Open the Steam mobile app, choose the QR scanner, and scan this code.
      </p>
      <Show
        when={props.qrImage}
        fallback={
      ...
      >
        <img
          class="mt-5 aspect-square w-full max-w-md rounded-2xl bg-white p-3"
          src={props.qrImage}
