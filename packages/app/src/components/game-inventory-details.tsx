...
import { ItemImage, marketURL, SteamItemDiagnostics, TF2ItemDiagnostics } from "./game-inventory-elements.js";
...
export function GameInventoryDetails(input: { props: GameInventoryViewProps; model: ReturnType<typeof createGameInventoryModel> }) {
  const props = input.props;
  const { marketPrices, selectedPriceScan, selectedPriceScanLoading, selected, selectedTF2Details, selectedTF2Item, selectedSteamItem, selectedServiceDetails, selectedSaleURL, selectedInventoryURL, selectedTF2Market, selectedTF2MarketPrice } = input.model;
  return (
          ...
          >
            {(item) => (
              <div>
                ...
                <GameInventoryTF2Actions props={props} model={input.model} item={item} />
